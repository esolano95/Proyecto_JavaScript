...
function operacion(){
    let suma = costo * canti + iva;
    alert("Costo total de su producto por la cantidad de unidades escogida (" + cantidad + ") es de "+suma+".")
}